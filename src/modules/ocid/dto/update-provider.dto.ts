...
//     example: 'consent',
//   }),
//   scope: z.string().trim().nullable().optional().meta({
...
// export class UpdateProviderDto extends createZodDto(updateUserSchema) {}
