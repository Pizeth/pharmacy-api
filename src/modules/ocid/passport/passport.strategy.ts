...
export class Strategy extends PassportStrategy {
   ...
   * @internal
   */
  private readonly _config: StrategyOptionsBase['config'];
  /**
   * @internal
   */
   ...
   * @internal
   */
  private readonly _callbackURL: Exclude<
    StrategyOptionsBase['callbackURL'],
    string
  >;
  /**
   * @internal
   */
  private readonly _sessionKey: NonNullable<StrategyOptionsBase['sessionKey']>;
  /**
   * @internal
   */
  private readonly _passReqToCallback: StrategyOptionsBase['passReqToCallback'];
  /**
   * @internal
   */
  private readonly _usePAR: StrategyOptionsBase['usePAR'];
  /**
   * @internal
   */
   ...
   * @internal
   */
  private readonly _DPoP: StrategyOptionsBase['DPoP'];
  /**
   * @internal
   */
  private readonly _scope: StrategyOptionsBase['scope'];
  /**
   * @internal
   */
  private readonly _resource: StrategyOptionsBase['resource'];
  /**
   * @internal
   */
  private readonly _authorizationDetails: StrategyOptionsBase['authorizationDetails'];
  ...
  authorizationRequestParams<TOptions extends AuthenticateOptions>(
    ...
    if (options?.resource) this.setResourceParams(params, options.resource);
  ...
  private async authorizationCodeGrant<TOptions extends AuthenticateOptions>(
    ...
    try {
      ...
      const input =
        req.method === 'POST'
          ? this.expressToUndiciRequest(req, currentUrl)
          : currentUrl;
